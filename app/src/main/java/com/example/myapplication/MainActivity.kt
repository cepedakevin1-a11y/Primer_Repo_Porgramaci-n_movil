...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        // Pasar savedInstanceState como parámetro
    ...
    // Recibir savedInstanceState como parámetro
...
@Composable
fun CounterApp() {
    // Obtener el ViewModel (se mantiene vivo durante la rotación)
    val viewModel: CounterViewModel = viewModel()

    // Observar el contador como StateFlow
